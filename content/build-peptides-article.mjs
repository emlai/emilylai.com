...
.mode{box-sizing:border-box;display:inline-flex;position:relative;flex:none;width:84px;height:44px;padding:0;gap:0;border:0;border-radius:5px;background:transparent}.mode::before{content:"";position:absolute;inset:0;background:var(--steel-toggle-light) center/100% 100% no-repeat;pointer-events:none}html[data-theme="dark"] .mode::before{background-image:var(--steel-toggle-dark)}.mode button{box-sizing:border-box;width:42px;height:44px;padding:0;border:0;border-radius:4px;background:transparent;cursor:pointer;z-index:1}.mode button svg{visibility:hidden}.mode button:focus-visible{outline:2px solid var(--ink);outline-offset:2px}silver-toggle{display:inline-block;flex:none;width:84px;height:44px}
.hero{max-width:1180px;margin:56px auto 72px;padding:0 40px}.eyebrow,.kicker,.chapter-number,.chapter-date{font-family:var(--sans);font-weight:650;letter-spacing:.075em;text-transform:uppercase}.eyebrow{margin:0 0 22px;color:var(--muted);font-size:13px}.hero h1{max-width:1000px;margin:0;color:var(--ink);font:700 clamp(52px,9vw,116px)/.88 var(--sans);letter-spacing:-.065em}.subtitle{max-width:760px;margin:30px 0 0;color:var(--ink);font:600 clamp(20px,2.5vw,30px)/1.2 var(--sans);letter-spacing:-.02em}.updated{margin:15px 0 0;color:var(--muted);font:14px/1.4 var(--sans)}
...
<main>
<header class="hero"><p class="eyebrow">LAB NOTES</p><h1>${escape(article.title)}</h1><p class="subtitle">${escape(article.subtitle)}</p><p class="updated">${escape(article.updated)}</p></header>
